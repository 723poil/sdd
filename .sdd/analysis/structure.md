...
- `.`: 주요 파일 156개. 소스 140개, 진입점 7개, 설정 파일 4개 중심 경로입니다. (main)
- `src`: 주요 파일 149개. 소스 137개, 진입점 7개, 레포지토리 4개 중심 경로입니다. (main)
- `src/application/app-settings`: 주요 파일 4개. 소스 4개 중심 경로입니다. (application)
- `src/application/project`: 주요 파일 27개. 소스 27개 중심 경로입니다. (application)
