...
- src/application/project/source -> shared/shared/source: 정적 참조 26건. 예시: `src/application/project/activate-project.use-case.ts -> src/shared/contracts/result.ts`.
- main/main/source -> src/application/project/source: 정적 참조 23건. 예시: `src/main/ipc/project-ipc-registration.ts -> src/application/project/activate-project.use-case.ts`.
...
- 전체 파일 참조는 499건이며, 자세한 관계는 파일 인덱스와 참조 맵에서 확인할 수 있습니다.